...
$pdf=new PDF('L');
$pdf->AddPage();
$pdf->Cell(200, 13, "Generated information for all Complains". date('F j, Y'), 0, 1);
//First table: put all columns automatically


//client information
$pdf->Cell(100, 15, "Complaint Details", 0, 2);
$pdf->Table("select regno,cunit,lecturer,xmonth,xyear,details,markscat from complain");

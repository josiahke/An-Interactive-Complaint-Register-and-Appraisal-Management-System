...
$pdf->Table("select regno,course,year,sem from complain where cid='$id2'"); 

//client information
$pdf->Cell(100, 15, "Complaint Details", 0, 2);
$pdf->Table("select cunit,lecturer,room,xmonth,xyear,details,markscat from complain where cid='$id2'");

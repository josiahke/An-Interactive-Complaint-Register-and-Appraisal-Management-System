...
?>
  ...
  <div id="tabs" style="font-size:12px;">
	<ul>
		<li><a href="#tabs-1">Existing lecturer profiles</a></li>
		<li><a href="#tabs-2">Add New Lecturer profile</a></li>
        <li><a href="#tabs-3">Add New Lecturer polls</a></li>
	</ul>
	<!-- begin tab 1 -->   
	<div id="tabs-1">
...
<script type="text/javascript">
    ...
    <div id="tabs-2">
    <h3 align="center"> Add new Lecturer profile</h3>
    <form action="_save_lect.php" method="post" name="register" id="register">
    <label> Full names:</label><br />
    <input name="names" type="text"  title="lecturer names" required  class="normaltip"/>
    <br />
    <label> Username:</label><br />
    <input name="username" type="text"  title="lecturer username" required  class="normaltip"/>
    <br />
    <label>Experience [in years]:</label><br />
    <input name="exp" type="text"  title="experience in profession" required  class="normaltip"/>
    <br />
     <label>Select Gender:</label> <br />
    <select name="gender" required  class="normaltip" title="Gender" ><option value=""> - select -</option><option value="male"> Male </option> <option value="female"> Female </option></select>
     <br />
     <label > Tel:</label><br />
     <input name="tel" type="text"  title="telephone contact" required  class="normaltip"/> 
    <br />
    <label> Education [i.e phd,masters etc separate by commas]:</label><br />
    <input name="edu" type="text"  title="education backgronund" required  class="normaltip"/>
    <br />
    <label> E-mail:</label><br />
    <input name="emailcontact" type="email"   title="email contact" required  class="normaltip" />
    <br />
    <input name="Create" type="submit" value="Create" />
     ...
     <div id="tabs-3">
    <h3 align="center"> Add new Lecturer poll</h3>
    <form action="_save_polls.php" method="post" name="savepoll" >
<label for="details" >Write Topic:</label> <br />
<textarea name="body" cols="50" rows="10" required title="Add your Topic" class='normaltip'></textarea>
 <br />
<label>Choice one:</label>  <br />
<input name="choice1" type="text" title="choice 1" required class='normaltip'/>
<br />
<label>Choice two:</label> <br />
<input name="choice2" type="text" title="choce 2" required class='normaltip'/>
<br />
<label>Choice three:</label> <br />
<input name="choice3" type="text" title="choice 3"  class='normaltip'/>
<br />
<label>Choice four:</label><br /> 
<input name="choice4" type="text" title="choice 4" class='normaltip'  />
<br />
<input name="Save Poll" type="submit" value="Save Poll" />
</form>
    </div>

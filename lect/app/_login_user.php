<?php
   ...
   //random no
	 ...
	 //login query
	$qry = "SELECT * FROM lecturer  WHERE username='$jinamsee' AND password='$enc_mseekey'";
	...
	if($result) {
		if(mysql_num_rows($result) > 0) {
			...
			session_register('cramis_sys_lect');
			$_SESSION['cramis_sys_lect']['jinamsee'] = $jinamsee;
			$_SESSION['cramis_sys_lect']['mseerd'] =enc($rd);
			$_SESSION['cramis_in_lect'] = true;
			$session = "1";
			session_write_close();
			header("location: index.php");
			exit();

...
?>
   ...
   <div id='content' >
	...
	<ul>
		<li><a href="#tabs-1">Poll Summary</a></li>
	</ul>
	<!-- begin tab 1 -->   
	<div id="tabs-1">
...
?>
   ...
   <tr>
    <td id='content_bottom'> <div id='content_bottom'> </div>
    <?php 
	//print_r ($ar);

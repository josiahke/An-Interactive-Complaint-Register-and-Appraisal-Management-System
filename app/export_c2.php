...
$pdf=new PDF('L');
$pdf->AddPage();
$pdf->Cell(200, 13, "Generated information for {$user} Complains". date('F j, Y'), 0, 1);
//First table: put all columns automatically

//folder information
$pdf->Cell(100, 15, "Student Details", 0, 2);
$pdf->Table("select regno,course,year,sem from complain where regno='$id2'"); 

//client information
$pdf->Cell(100, 15, "Complaint Details", 0, 2);
$pdf->Table("select cunit,lecturer,room,xmonth,xyear,details,markscat from complain where regno='$id2'");

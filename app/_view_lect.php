     ...
     <?php
      $list = "SELECT * FROM lecturer order by lectid desc";
			...
			if(mysql_num_rows($result) > 0)
			  ...
			  <br> 
			  &nbsp; <a href='_open_lect.php?id={$data['lectid']}' title='open this profile'>View Profile</a>";
			  	?>
                <?php
                ...
                if(mysql_num_rows($result1) > 0)
                        ...
                        ?>
                        <?php }?>
<div id='<?php $w=$pid + $id + $countall; echo $w; ?>' class='<?php echo $pid;?>' style="width:500px; height:100px;"> </div>
<script type="text/javascript">

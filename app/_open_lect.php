...
?>
  ...
  <div id="tabs" style="font-size:12px;">
	<ul>
		<li><a href="#tabs-1">Lecturer profile</a></li>
	</ul>
	<!-- begin tab 1 -->   
	<div id="tabs-1">
    ...
    <br />
    <div id="tabs2" style="font-size:12px;">
	<ul>
...
<form action="_save_vote.php?pollid=<?php echo $data['pid'];?>&lectid=<?php echo $id;?>&voter=<?php echo $user;?>" name="savevote" method="post">	
<?php echo $data['topic'];?> <hr />
<label><?php echo $data['choice1']; $c1=$data['choice1'];?> </label> 
<input name="vote" type="radio" value="<?php echo $data['choice1'];?>" />
<?php 
...
?>
<br /> 
<label><?php echo $data['choice2']; $c2=$data['choice2'];?> </label> 
<input name="vote" type="radio" value="<?php echo $data['choice2'];?>" /> 
<?php 
...
?>
<br />
<?php if ($data['choice3']=='') {  } else {?>
<label><?php echo $data['choice3']; $c3=$data['choice3'];?> </label> 
<input name="vote" type="radio" value="<?php echo $data['choice3'];?>" />  
<?php 
...
<?php } ?>
<br /> 
<?php if ($data['choice4']=='') {  }else {?>
<label><?php echo $data['choice4'];$c4=$data['choice4'];?> </label>
<input name="vote" type="radio" value="<?php echo $data['choice4']; ?>" /> 
<?php 
...
<br />
<br />
<input name="Save Vote" type="submit" value="Save Vote" />
</form> 
</td>    
     
<td width="300"> <div id='<?php echo $pid;?>' class='<?php echo $pid;?>' style="width:300px; height:100px;"> </div>
<script type="text/javascript">
